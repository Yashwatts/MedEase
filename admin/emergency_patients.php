...
$admin_username = $_SESSION['admin'] ?? ''; // Adjust this to match how you're storing the admin's session data
...
$location_sql = "SELECT hospital_location FROM admin WHERE username = ?";
...
<div class="sidenav" style="margin-top: -217px; height: 50rem; margin-left: -2px; position: fixed;">
